...
@app.post("/ocr/", summary="Extract text from image and return full text and lines with confidence")
async def perform_ocr(file: UploadFile = File(...)):
 ...
 """
    ...
    draw.text((text_x, text_y), f"Full Confidence: {avg_confidence:.3f}", fill="black", font=font)
    text_y += 30
